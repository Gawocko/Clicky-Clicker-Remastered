...
font = pygame.font.Font("soft_font_bold.otf", 150)
font2 = pygame.font.Font("soft_font_medium.otf", 100)
font3 = pygame.font.Font("soft_font_medium.otf", 40)
...
while running:
    ...
    font = pygame.font.Font("soft_font_bold.otf", int(125*(screen_width/1920)))
    font2 = pygame.font.Font("soft_font_medium.otf", int(75*(screen_width/1920)))
    screen_width, screen_height = screen.get_size()
    mouse_x, mouse_y = pygame.mouse.get_pos()
    mouse_xc = mouse_x - screen_width/2
    mouse_yc = mouse_y - screen_height/2
